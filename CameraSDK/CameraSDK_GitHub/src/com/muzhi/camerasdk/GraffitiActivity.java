 ...
 * 
 */
public class GraffitiActivity extends BaseActivity implements OnClickListener, OnSeekBarChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		showLeftIcon();
		setActionBarTitle(getString(R.string.camerasdk_tab_graffiti));
	...
	private void findViews() {
		showRightIcon(R.drawable.camerasdk_selector_edit_done, this);
...
//		brush_view_color.setBackgroundColor(brush_color);
	...
	private void initEvent() {
		...
		brush_view_color.setOnClickListener(this);
	}
...
//		brush_view_color.setBackgroundColor(color);
	...
	@Override
	public void onClick(View v) {
		if(v == getRightImageView()) {
			done();
		} else if (v == btn_brush) {
			initBrush();
			seekbar_brush.setVisibility(View.VISIBLE);
			seekbar_eraser.setVisibility(View.GONE);
		} else if (v == btn_eraser) {
			initEraser();
			seekbar_brush.setVisibility(View.GONE);
			seekbar_eraser.setVisibility(View.VISIBLE);
		} else if (v == brush_view_color) {
			// TODO 颜色选择器
			showPopupColor(v);
		}
	}
