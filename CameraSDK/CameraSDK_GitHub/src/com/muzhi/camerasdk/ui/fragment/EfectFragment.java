...
public class EfectFragment extends Fragment {
	...
	//加贴纸
	public void addSticker(Bitmap bmp) {
		sticknum++;
		HSuperImageView imageView = new HSuperImageView(getActivity(), sticknum);
	 ...
	 * @return
	 */
	public String getFilterImage(int quality){
		...
		try{
			...
			String path = saveAsBitmap(mContext, bitmap, quality);
			bitmap.recycle();
			return path;
		}
		catch(Exception e){
	...
	/////////////////////////////////////////////////////////////////
	// 添加保存图片的质量选择 2016-05-20
	/////////////////////////////////////////////////////////////////
	private String saveAsBitmap(Context context, Bitmap bitmap, int quality) {
