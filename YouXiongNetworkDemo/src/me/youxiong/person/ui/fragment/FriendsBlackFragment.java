...
import me.youxiong.person.adapter.AdapterFriendsBlack;
 ...
 *
 */
public class FriendsBlackFragment extends BaseFragment {
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		AdapterFriendsBlack adapter = new AdapterFriendsBlack(mActivity);
